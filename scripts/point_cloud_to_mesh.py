...
class DelaunayMeshGenerator:
    ...
    def __init__(self):
        ...
        self.edge_width = rospy.get_param('~edge_width', 0.03)  # Width of edges (THICKER!)
    ...
    def generate_delaunay_mesh_with_edges(self, points, header):
        ...
        edges_marker.scale.x = self.edge_width  # Line width (only x is used for LINE_LIST)
        edges_marker.scale.y = 0.0  # Not used for LINE_LIST
        edges_marker.scale.z = 0.0  # Not used for LINE_LIST
        edges_marker.color = ColorRGBA(1.0, 0.0, 0.0, 1.0)  # BRIGHT RED edges!
